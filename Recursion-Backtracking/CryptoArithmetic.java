...
public class CryptoArithmetic {
  ...
  public static int getNumber(String word, HashMap<Character, Integer> charIntMap) {
  ...
  public static void solution(String unique, int idx, HashMap<Character, Integer> charIntMap, boolean[] usedNumbers,
    ...
    if (idx == unique.length()) {
      int s1num = getNumber(s1, charIntMap);
      int s2num = getNumber(s2, charIntMap);
      int s3num = getNumber(s3, charIntMap);
